...
public class RockScript : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!this.disable)
        {
            ...
            transform3.position += (Vector3) (this.vh * Time.deltaTime);
            if ((Vector3.Distance(this.desPt, base.transform.position) < 20f) || (base.transform.position.y < 0f))
            {
                ...
                if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.MULTIPLAYER) && PhotonNetwork.isMasterClient)
                {
                    ...
                    {
                        Network.Instantiate(Cach.FX_boom1_CT_KICK != null ? Cach.FX_boom1_CT_KICK : Cach.FX_boom1_CT_KICK = (GameObject)Resources.Load("FX/boom1_CT_KICK"), base.transform.position + ((Vector3)(Vector3.up * 30f)), Quaternion.Euler(270f, 0f, 0f), 0);
                    }
                    else
                    {
                ...
                {
                    UnityEngine.Object.Instantiate(Cach.FX_boom1_CT_KICK != null ? Cach.FX_boom1_CT_KICK : Cach.FX_boom1_CT_KICK = (GameObject)Resources.Load("FX/boom1_CT_KICK"), base.transform.position + ((Vector3)(Vector3.up * 30f)), Quaternion.Euler(270f, 0f, 0f));
                }
                this.disable = true;
            }
        }
