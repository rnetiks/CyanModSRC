...
public class iTween : MonoBehaviour
{
    ...
    private void ApplyColorToTargets()
    {
        ...
        if (base.GetComponent<UnityEngine.GUITexture>() != null)
        {
        ...
        if (this.percentage == 1f)
        {
            if (GetComponent<UnityEngine.GUITexture>() != null)
            {
    ...
    public static GameObject CameraFadeAdd()
    {
        ...
        cameraFade.AddComponent<UnityEngine.GUITexture>();
    ...
    public static void ColorFrom(GameObject target, Hashtable args)
    {
        ...
        if (target.GetComponent<UnityEngine.GUITexture>() != null)
        {
