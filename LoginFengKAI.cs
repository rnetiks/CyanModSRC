...
public class LoginFengKAI : MonoBehaviour
{
    ...
    {
        return new changeGuildc__Iterator5
        {
            name = name,
            f__this = this
        };
    ...
    {
        return new changePasswordc__Iterator4
        {
    ...
    {
        return new ForgetPasswordc__Iterator6
        {
            email = email,
            f__this = this
        };
    ...
    {
        return new Registerc__Iterator3
        {
            name = name,
            password = password,
            password2 = password2,
    ...
    [CompilerGenerated]
    private sealed class changeGuildc__Iterator5 : IEnumerator<object>, IDisposable, IEnumerator
    {
    ...
    [CompilerGenerated]
    private sealed class changePasswordc__Iterator4 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal LoginFengKAI f__this;
        internal WWWForm form__0;
    ...
    [CompilerGenerated]
    private sealed class ForgetPasswordc__Iterator6 : IEnumerator<object>, IDisposable, IEnumerator
    {
    ...
    [CompilerGenerated]
    private sealed class getInfoc__Iterator2 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal LoginFengKAI f__this;
        internal WWWForm form__0;
    ...
    [CompilerGenerated]
    private sealed class Loginc__Iterator1 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal LoginFengKAI f__this;
        internal WWWForm form__0;
        internal string name;
    ...
    [CompilerGenerated]
    private sealed class Registerc__Iterator3 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal string email;
        internal LoginFengKAI f__this;
        internal WWWForm form__0;
