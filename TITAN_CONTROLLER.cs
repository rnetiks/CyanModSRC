...
public class TITAN_CONTROLLER : MonoBehaviour
{
    ...
    public bool attackFace;

    private void Start()
    {
        this.currentCamera = CyanMod.CachingsGM.Find<Camera>("MainCamera");
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            if (FengGameManagerMKII.inputRC.isInputTitan(InputCodeRC.titanAttackFace))
            {
                attackFace = true;
            }
            if (FengGameManagerMKII.inputRC.isInputTitan(InputCodeRC.titanAttackDown))
            {
                attackDown = true;
            }
            if (FengGameManagerMKII.inputRC.isInputTitan(InputCodeRC.titanSitDown))
            {
                sitdown = true;
            }
            if (FengGameManagerMKII.inputRC.isInputTitan(InputCodeRC.titanlaugh))
            {
                laugh = true;
            }
