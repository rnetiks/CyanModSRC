...
public class HERO_SETUP : MonoBehaviour
{
    ...
    public void create3DMG()
    {
        ...
        if (this.myCostume.weapon_l_mesh.Length > 0)
        {
            ...
            {
                this.part_blade_l.transform.Find("X-WeaponTrailA").GetComponent<XWeaponTrail>().Deactivate(true);
                this.part_blade_l.transform.Find("X-WeaponTrailB").GetComponent<XWeaponTrail>().Deactivate(true);
        ...
        if (this.myCostume.weapon_r_mesh.Length > 0)
        {
            ...
            {
                this.part_blade_r.transform.Find("X-WeaponTrailA").GetComponent<XWeaponTrail>().Deactivate(true);
                this.part_blade_r.transform.Find("X-WeaponTrailB").GetComponent<XWeaponTrail>().Deactivate(true);
                if (base.gameObject.GetComponent<HERO>() != null)
                {
