...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    {
        return string.Format("View ({3}){0} on {1} {2}",
            new object[]
            {
                this.viewID, (base.gameObject == null) ? "GO==null" : base.gameObject.name,
                !this.isSceneView ? string.Empty : "(scene)", this.prefix
            });
    }
    ...
    public int viewID
    {
        get {return ((this.ownerId*PhotonNetwork.MAX_VIEW_IDS) + this.subId); }
        set
        {
