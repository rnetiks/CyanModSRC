namespace Xft
{
    ...
    public class XWeaponTrail : MonoBehaviour
    {
        ...
        public void Deactivate(bool flag)
        {
            if (FengGameManagerMKII.settings != null && (int)FengGameManagerMKII.settings[360] == 0 || flag)
            {
        ...
        {
            if (this.mIsFading && (int)FengGameManagerMKII.settings[360] == 0)
            {
        ...
        {
            get { return ((Vector3) ((this.PointStart.position + this.PointEnd.position)/2f)); }
        }

        public float TrailWidth
        {
            get { return this.mTrailWidth; }
        }

        public float UpdateInterval
        {
            get { return (1f/this.Fps); }
        }
        ...
        public class Element
        {
            ...
            public Vector3 Pos
            {
                get { return ((Vector3) ((this.PointStart + this.PointEnd)/2f)); }
            }
        }
    }
}
