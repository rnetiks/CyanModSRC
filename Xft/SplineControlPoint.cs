namespace Xft
{
    ...
    public class SplineControlPoint
    {
        ...
        public bool IsValid
        {
            get { return (this.NextControlPoint != null); }
        }

        public SplineControlPoint NextControlPoint
        {
            get { return this.mSpline.NextControlPoint(this); }
        }

        public Vector3 NextNormal
        {
            get { return this.mSpline.NextNormal(this); }
        }

        public Vector3 NextPosition
        {
            get { return this.mSpline.NextPosition(this); }
        }

        public SplineControlPoint PreviousControlPoint
        {
            get { return this.mSpline.PreviousControlPoint(this); }
        }

        public Vector3 PreviousNormal
        {
            get { return this.mSpline.PreviousNormal(this); }
        }

        public Vector3 PreviousPosition
        {
            get { return this.mSpline.PreviousPosition(this); }
        }
    }
}
