...
public class Sprite
{
    ...
    public void SetRotationTo(Vector3 dir)
    {
        if (dir != Vector3.zero)
        {
            ...
            {
                Quaternion quaternion3 = Quaternion.FromToRotation(this.LocalMat.MultiplyPoint3x4(this.v3), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion3;
            }
            else if (this.OriPoint == ORIPOINT.LEFT_BOTTOM)
            {
                Quaternion quaternion4 = Quaternion.FromToRotation(this.LocalMat.MultiplyPoint3x4(this.v4), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion4;
            }
            else if (this.OriPoint == ORIPOINT.RIGHT_BOTTOM)
            {
                Quaternion quaternion5 = Quaternion.FromToRotation(this.LocalMat.MultiplyPoint3x4(this.v1), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion5;
            }
            else if (this.OriPoint == ORIPOINT.RIGHT_UP)
            {
                Quaternion quaternion6 = Quaternion.FromToRotation(this.LocalMat.MultiplyPoint3x4(this.v2), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion6;
            }
            else if (this.OriPoint == ORIPOINT.BOTTOM_CENTER)
            {
                Quaternion quaternion7 = Quaternion.FromToRotation(new Vector3(0f, 0f, 1f), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion7;
            }
            else if (this.OriPoint == ORIPOINT.TOP_CENTER)
            {
                Quaternion quaternion8 = Quaternion.FromToRotation(new Vector3(0f, 0f, -1f), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion8;
            }
            else if (this.OriPoint == ORIPOINT.RIGHT_CENTER)
            {
                Quaternion quaternion9 = Quaternion.FromToRotation(new Vector3(-1f, 0f, 0f), toDirection);
                identity = Quaternion.FromToRotation(toDirection, dir) * quaternion9;
            }
            else if (this.OriPoint == ORIPOINT.LEFT_CENTER)
            {
                Quaternion quaternion10 = Quaternion.FromToRotation(new Vector3(1f, 0f, 0f), toDirection);
