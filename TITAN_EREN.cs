...
public class TITAN_EREN : Photon.MonoBehaviour
{
    ...
    public void born()
    {
        foreach (GameObject obj2 in FengGameManagerMKII.instance.alltitans)
        {
            FEMALE_TITAN ft = obj2.GetComponent<FEMALE_TITAN>();
            if (ft != null)
            {
                ft.erenIsHere(base.gameObject);
            }
        }
        ...
        {
            UnityEngine.Object.Instantiate(Cach.Thunder != null ? Cach.Thunder : Cach.Thunder = (GameObject)Resources.Load("FX/Thunder"), base.transform.position + ((Vector3)(Vector3.up * 23f)), Quaternion.Euler(270f, 0f, 0f));
        }
        ...
        if (!IN_GAME_MAIN_CAMERA.isPausing || (IN_GAME_MAIN_CAMERA.gametype != GAMETYPE.SINGLE))
        {
            ...
            else if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
            {
                ...
                else if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
                {
                    ...
                    if (!this.isAttack && !this.isHit)
                    {
                        if (this.grounded)
                        {
                            ...
                            if (this.justGrounded)
                            {
                                ...
                                {
                                    GameObject obj2 = (GameObject)UnityEngine.Object.Instantiate(Cach.boom2_eren != null ? Cach.boom2_eren : Cach.boom2_eren = (GameObject)Resources.Load("FX/boom2_eren"), base.transform.position, Quaternion.Euler(270f, 0f, 0f));
                            ...
                            if ((!base.animation.IsPlaying("jump_land") && !this.isAttack) && (!this.isHit && !base.animation.IsPlaying("born")))
                            {
                                ...
                                float num9 = (vector2.magnitude <= 0.95f) ? ((vector2.magnitude >= 0.25f) ? vector2.magnitude : 0f) : 1f;
                        ...
                        else
                        {
                            ...
                            {
                                Vector3 vector5 = new Vector3(x, 0f, z);
                                ...
                                Vector3 vector6 = new Vector3(num14, 0f, num15);
                                float num16 = (vector5.magnitude <= 0.95f) ? ((vector5.magnitude >= 0.25f) ? vector5.magnitude : 0f) : 1f;
                                vector6 = (Vector3) (vector6 * num16);
                                vector6 = (Vector3) (vector6 * (this.speed * 2f));
                                if ((x == 0f) && (z == 0f))
                                {
                                    num12 = -874f;
                                }
                                ...
                                {
                                    base.rigidbody.AddForce(vector6, ForceMode.Impulse);
                                }
                                if (num12 != -874f)
                                {
                    ...
                    {
                        Vector3 vector7 = (base.transform.position - base.transform.Find("Amarture/Core").position) - this.oldCorePosition;
                        this.oldCorePosition = base.transform.position - base.transform.Find("Amarture/Core").position;
                        base.rigidbody.velocity = (Vector3) ((vector7 / Time.deltaTime) + (Vector3.up * base.rigidbody.velocity.y));
                        base.rigidbody.rotation = Quaternion.Lerp(base.gameObject.transform.rotation, Quaternion.Euler(0f, this.facingDirection, 0f), Time.deltaTime * 10f);
                        if (this.justGrounded)
                        {
                            this.justGrounded = false;
    ...
    public void hitByFT(int phase)
    {
        if (!this.hasDied)
        {
            ...
            if (phase == 3)
            {
                ...
                {
                    obj2 = (GameObject)UnityEngine.Object.Instantiate(Cach.bloodExplore != null ? Cach.bloodExplore : Cach.bloodExplore = (GameObject)Resources.Load("bloodExplore"), transform.position + ((Vector3)((Vector3.up * 1f) * 4f)), Quaternion.Euler(270f, 0f, 0f));
                }
                ...
                {
                    obj2 = (GameObject)UnityEngine.Object.Instantiate(Cach.bloodsplatter != null ? Cach.bloodsplatter : Cach.bloodsplatter = (GameObject)Resources.Load("bloodsplatter"), transform.position, Quaternion.Euler(90f + transform.rotation.eulerAngles.x, transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z));
                }
                obj2.transform.localScale = base.transform.localScale;
                ...
                {
                    obj2 = (GameObject)UnityEngine.Object.Instantiate(Cach.justSmoke != null ? Cach.justSmoke : Cach.justSmoke = (GameObject)Resources.Load("FX/justSmoke"), transform.position, Quaternion.Euler(270f, 0f, 0f));
                }
                obj2.transform.parent = transform;
            }
        }
    ...
    public void lateUpdate()
    {
        ...
        {
            Quaternion to = Quaternion.Euler(CyanMod.CachingsGM.Find("MainCamera").transform.rotation.eulerAngles.x, CyanMod.CachingsGM.Find("MainCamera").transform.rotation.eulerAngles.y, 0f);
            CyanMod.CachingsGM.Find("MainCamera").transform.rotation = Quaternion.Lerp(CyanMod.CachingsGM.Find("MainCamera").transform.rotation, to, Time.deltaTime * 2f);
        }
    }
    ...
    private void netTauntAttack(float tauntTime, float distance = 100f)
    {
        foreach (GameObject obj2 in FengGameManagerMKII.instance.alltitans)
        {
            ...
            if ((Vector3.Distance(obj2.transform.position, base.transform.position) < distance) && (tit != null))
            {
                tit.beTauntedBy(base.gameObject, tauntTime);
            }
            FEMALE_TITAN ft = obj2.GetComponent<FEMALE_TITAN>();
            if (ft != null)
            {
            ...
            if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
            {
                ...
                else if (this.rockPhase == 4)
                {
                    ...
                    if (this.waitCounter > 4.2f)
                    {
                        ...
                        object[] objArray2 = new object[] { "move" };
                        base.photonView.RPC("rockPlayAnimation", PhotonTargets.All, objArray2);
                ...
                else if (this.rockPhase == 5)
                {
                    if (Vector3.Distance(base.transform.position, this.targetCheckPt) < 10f)
                    {
                        if (this.checkPoints.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                GameObject[] objArray3 = GameObject.FindGameObjectsWithTag("titanRespawn2");
                                GameObject obj2 = CyanMod.CachingsGM.Find("titanRespawnTrost" + (7 - this.checkPoints.Count));
                                if (obj2 != null)
                                {
                                    foreach (GameObject obj3 in objArray3)
                                    {
                                        if (obj3.transform.parent.gameObject == obj2)
                                        {
                                            TITAN titan = FengGameManagerMKII.instance.spawnTitan(70, obj3.transform.position, obj3.transform.rotation, false);
                                            titan.isAlarm = true;
                                            titan.chaseDistance = 999999f;
                                        }
                                    }
                                }
                            }
                    ...
                    if ((this.checkPoints.Count > 0) && (UnityEngine.Random.Range(0, 0xbb8) < (10 - this.checkPoints.Count)))
                    {
                        ...
                        float y = 0f;
                        if (Physics.Raycast(position + ((Vector3) (Vector3.up * 500f)), -Vector3.up, out hit, 1000f, mask.value))
                        {
                            y = hit.point.y;
                        }
                        position += (Vector3) (Vector3.up * y);
                        TITAN titan = FengGameManagerMKII.instance.spawnTitan(70, position, base.transform.rotation, false);
                        titan.isAlarm = true;
                        titan.chaseDistance = 999999f;
                    }
                ...
                else if (this.rockPhase == 7)
                {
                    ...
                    if ((base.animation["rock_fix_hole"].normalizedTime >= 0.62f) && !this.rockHitGround)
                    {
                        ...
                        {
                            UnityEngine.Object.Instantiate(Cach.FX_boom1_CT_KICK != null ? Cach.FX_boom1_CT_KICK : Cach.FX_boom1_CT_KICK = (GameObject)Resources.Load("FX/boom1_CT_KICK"), new Vector3(0f, 30f, 684f), Quaternion.Euler(270f, 0f, 0f));
                        }
                    }
                }
            }
    ...
    {
        GameObject obj2 = CyanMod.CachingsGM.Find("routeTrost");
    ...
    {
        GameObject obj2 = CyanMod.CachingsGM.Find("cross1");
        GameObject obj3 = CyanMod.CachingsGM.Find("cross2");
        GameObject obj4 = CyanMod.CachingsGM.Find("crossL1");
        GameObject obj5 = CyanMod.CachingsGM.Find("crossL2");
        GameObject obj6 = CyanMod.CachingsGM.Find("crossR1");
        GameObject obj7 = CyanMod.CachingsGM.Find("crossR2");
        GameObject obj8 = CyanMod.CachingsGM.Find("LabelDistance");
    ...
    UISprite skill_cd_eren;
    private void showSkillCD()
    {
       ( skill_cd_eren != null ?skill_cd_eren : skill_cd_eren = CyanMod.CachingsGM.Find("skill_cd_eren").GetComponent<UISprite>()).fillAmount = this.lifeTime / this.lifeTimeMax;
    }
    ...
    private void Start()
    {
        ...
        if (this.rockLift)
        {
            this.rock = CyanMod.CachingsGM.Find("rock");
            this.rock.animation["lift"].speed = 0f;
        }
        else
        {
            this.currentCamera = CyanMod.CachingsGM.Find("MainCamera").GetComponent<Camera>();
            this.oldCorePosition = base.transform.position - base.transform.Find("Amarture/Core").position;
            ...
            if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
            {
                ...
                else if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_attack0) || FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_attack1))
                            {
                                bool flag = false;
                                if (((IN_GAME_MAIN_CAMERA.cameraMode == CAMERA_TYPE.WOW) && FengGameManagerMKII.inputRC.isInputCustomKey(InputCode.custom_down)) || FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_attack1))
                                {
                                    if (((IN_GAME_MAIN_CAMERA.cameraMode == CAMERA_TYPE.WOW) && FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_attack1)))
                                    {
                                        flag = true;
                                    }
                                    if (flag)
                            ...
                            if (FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_salute))
                            {
                        ...
                        if (!this.isAttack)
                        {
                            if ((this.grounded || base.animation.IsPlaying("idle")) && ((!base.animation.IsPlaying("jump_start") && !base.animation.IsPlaying("jump_air")) && (!base.animation.IsPlaying("jump_land") && FengGameManagerMKII.inputRC.isInputCustomKey(InputCode.custom_bothRope))))
                            {
                        ...
                        {
                            if ((base.animation[this.attackAnimation].time >= 0.1f) && FengGameManagerMKII.inputRC.isInputCustomKeyDown(InputCode.custom_attack0))
                            {
                            ...
                            if (((base.animation[this.attackAnimation].normalizedTime >= num) && (base.animation[this.attackAnimation].normalizedTime <= num2)) || (!this.attackChkOnce && (base.animation[this.attackAnimation].normalizedTime >= num)))
                            {
                                ...
                                for (int i = 0; i < colliderArray.Length; i++)
                                {
                                    ...
                                    if (!flag2 && !colliderArray[i].gameObject.transform.root.GetComponent<TITAN>().hasDie)
                                    {
                                        ...
                                        {
                                            UnityEngine.Object.Instantiate(Cach.hitMeatBIG != null ? Cach.hitMeatBIG : Cach.hitMeatBIG = (GameObject)Resources.Load("hitMeatBIG"), (Vector3)((colliderArray[i].transform.position + this.attackBox.position) * 0.5f), Quaternion.Euler(270f, 0f, 0f));
                                        }
                                    }
                                }
                            }
